...
public:
	...
	virtual int WritePos(u8 ID, u16 Position, u16 Time, u16 Speed = 0);//单个舵机位置指令
	virtual void SyncWritePos(u8 ID[], u8 IDN, u16 Position[], u16 Time[], u16 Speed[]);//多个舵机同步位置指令
